...
| T1528 | Steal Web Session Cookie  | Credential Access                        | Expiración corta de tokens JWT y validación estricta de origen.                     |
| T1078 | Valid Accounts                      | Initial Access                                 | MFA obligatorio para administradores y monitoreo de anomalías de login. |

6.2 Visualización
*(Insertar aquí captura de pantalla del MITRE ATT&CK Navigator destacando las tácticas de "Initial Access", "Credential Access" e "Impact" asociadas al Escenario 8)*
